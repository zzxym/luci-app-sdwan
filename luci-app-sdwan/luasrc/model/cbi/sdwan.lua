...
btncq.write = function()
  luci.sys.call("rm -rf /tmp/sdwan*.tag /tmp/sdwan*.newtag >/dev/null 2>&1 &") -- 执行删除版本号信息
...
sdwancmd = s:taboption("general", ListValue, "sdwancmd", translate("Startup Method"),
        translate("Please note to set the RPC port to 15888"))
...
sdwancmd:value("web", translate("Web Configuration"))
 ...
 sdwan_config = s:taboption("general", TextValue, "sdwan_config", translate("Configuration File"),
...
sdwan_config.rows = 18
sdwan_config.wrap = "off"
sdwan_config:depends("sdwancmd", "config")

 sdwan_config.cfgvalue = function(self, section)
    return nixio.fs.readfile("/etc/sdwan/config.toml") or ""
end
 sdwan_config.write = function(self, section, value)
    local dir = "/etc/sdwan/"
...
peeradd = s:taboption("general", DynamicList, "peeradd", translate("Peer Nodes"),
        translate("Initial connected peer nodes (-p parameter)"))
peeradd.placeholder = "tcp://public.sdwan.top:11010"
peeradd:value("tcp://public.sdwan.top:11010", translate("Public Server - tcp://public.sdwan.top:11010"))
...
hostname_opt:depends("sdwancmd", "sdwancmd")
hostname_opt:depends("sdwancmd", "web")
...
p2p_only:depends("sdwancmd", "sdwancmd")
...
udp_white_port:depends("sdwancmd", "sdwancmd")
...
disable_tcp:depends("sdwancmd", "sdwancmd")
...
tcp_white_port:depends("sdwancmd", "sdwancmd")
...
disable_sym:depends("sdwancmd", "sdwancmd")
...
disable_relay_kcp:depends("sdwancmd", "sdwancmd")
...
relay_kcp:depends("sdwancmd", "sdwancmd")
...
conninfo.template = "sdwan/sdwan_conninfo"
...
upload.description = translate("You can directly upload the binary programs sdwan-core and sdwan-cli, or a compressed .zip archive. "
        .. "Uploading a new version will automatically overwrite the old one.<br>"
...
web_btncq.write = function()
  luci.sys.call("/etc/init.d/sdwan restart >/dev/null 2>&1 &")
end
...
web_db_path.default = "/etc/sdwan/sdwan.db"
...
web_geoip_db.placeholder = "/etc/sdwan/GeoLite.mmdb"
